function RTW_Sid2UrlHash() {
	...
	/* <Root>/Blink */
	this.urlHashMap["blinkTest:3"] = "blinkTest.c:32,35&Blink.c:26";
	/* <Root>/Chart */
	this.urlHashMap["blinkTest:5"] = "blinkTest.c:37";
	/* <Root>/Pin */
	this.urlHashMap["blinkTest:6"] = "blinkTest.c:38";
	/* <Root>/Scope */
	this.urlHashMap["blinkTest:7"] = "msg=&block=blinkTest:7";
	/* <S1>/Chart */
	this.urlHashMap["blinkTest:1"] = "blinkTest.h:42,47,48,49&Blink.c:22,29,69";
	/* <S1>/Out1 */
	this.urlHashMap["blinkTest:4"] = "msg=&block=blinkTest:4";
	/* <S2>:2 */
	this.urlHashMap["blinkTest:5:2"] = "blinkTest.c:43";
	/* <S2>:4 */
	this.urlHashMap["blinkTest:5:4"] = "blinkTest.c:44";
	/* <S3>:2 */
	this.urlHashMap["blinkTest:1:2"] = "Blink.c:45,48,64";
	/* <S3>:1 */
	this.urlHashMap["blinkTest:1:1"] = "Blink.c:54,58";
	/* <S3>:6 */
	this.urlHashMap["blinkTest:1:6"] = "Blink.c:41";
	/* <S3>:3 */
	this.urlHashMap["blinkTest:1:3"] = "Blink.c:60";
	/* <S3>:4 */
	this.urlHashMap["blinkTest:1:4"] = "Blink.c:50";
