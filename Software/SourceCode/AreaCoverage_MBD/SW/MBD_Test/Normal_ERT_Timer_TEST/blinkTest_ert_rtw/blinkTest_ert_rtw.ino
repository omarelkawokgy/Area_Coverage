...
#define PROJECT_ROOT C:\Projects\myProject\CleanerRepo\Area_Coverage\Software\SourceCode\AreaCoverage_MBD\SW\MBD_Test\Normal_ERT_blinkTest_ert_rtw
...
#include RELATIVE_PATH(I_O_Wrapper.h)
