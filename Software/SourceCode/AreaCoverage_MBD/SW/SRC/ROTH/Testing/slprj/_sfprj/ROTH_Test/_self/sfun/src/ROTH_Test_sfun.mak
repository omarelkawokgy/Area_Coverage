...
TARGET      = sfun
MODULE_SRCS   = 
MODEL_SRC  = ROTH_Test_sfun.c
MODEL_REG = ROTH_Test_sfun_registry.c
MAKEFILE    = ROTH_Test_sfun.mak
...
MLSLSF_INCLUDES = \
    ...
    /I "C:\Users\oelkawok\Downloads\Area_Coverage-master (1)\Area_Coverage-master\AreaCoverage_MBD\SW\SRC\ROTH\Testing\slprj\_sfprj\ROTH_Test\_self\sfun\src" 
...
OBJLIST_FILE = ROTH_Test_sfun.mol
SFCLIB = 
AUX_LNK_OBJS =     
USER_LIBS = 
#--------------------------------- Rules --------------------------------------
