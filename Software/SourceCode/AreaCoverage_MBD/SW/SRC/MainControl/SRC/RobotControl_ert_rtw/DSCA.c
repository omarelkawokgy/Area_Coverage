...
void RobotControl_DSCA_Init(void)
{
  ...
  RobotControl_DW.Unit_Delay4_DSTATE_m = false;
...
void RobotControl_DSCA(void)
{
   ...
   */
  rtb_Switch_j = (RobotControl_B.A1 > RobotControl_P.CAL_EncoderAnaThd);
   ...
   */
  rtb_Switch1_k = (RobotControl_B.A0 > RobotControl_P.CAL_EncoderAnaThd);
  ...
  rtb_Gain3_b = ((78125.0F * MotorTransferFunction_tmp + 156250.0F *
    ...
    RobotControl_P.gearRatio * ((real32_T)(uint8_T)(10U *
    RobotControl_P.CAL_WheelDiameter_cm) / RobotControl_P.CONST_TWO_F32);
   ...
   *  Sum: '<S81>/Add2'
   */
  MotorTransferFunction_tmp_i = (((real32_T)(rtb_rightPosPin_z - rtb_rightNegPin)
    * 0.0470581055F - -237187.5F *
    RobotControl_DW.MotorTransferFunction_states_n[0L]) - -549093.75F *
    RobotControl_DW.MotorTransferFunction_states_n[1L]) / 951906.25F;
   ...
   *  Product: '<S81>/Divide1'
   */
  rtb_Gain3_b = ((78125.0F * MotorTransferFunction_tmp_i + 156250.0F *
                  RobotControl_DW.MotorTransferFunction_states_n[0L]) + 78125.0F
                 * RobotControl_DW.MotorTransferFunction_states_n[1L]) /
    (real32_T)RobotControl_P.gearRatio * ((real32_T)(uint8_T)(10U *
    RobotControl_P.CAL_WheelDiameter_cm) / RobotControl_P.CONST_TWO_F32);
   ...
   *  Gain: '<S54>/Gain3'
   */
  RobotControl_B.Data_Type_Conversion = 0.2F * rtb_Switch_i;
   ...
   *  Gain: '<S55>/Gain3'
   */
  RobotControl_B.Data_Type_Conversion_m = 0.2F * rtb_Gain3_b;

  /* Outputs for Enabled SubSystem: '<S19>/EncoderThetaCalculation' incorporates:
   *  EnablePort: '<S48>/EncoderThetaEnable'
   */
  /* Logic: '<S19>/Logical_Operator1' incorporates:
   *  Constant: '<S19>/ENU_DIAG'
   *  RelationalOperator: '<S19>/Relational_Operator'
   *  UnitDelay: '<S19>/Unit_Delay2'
   */
  if ((RobotControl_DW.Unit_Delay2_DSTATE_b == RobotControl_P.ENU_DIAG) ||
    ...
    RobotControl_B.Add1_l = (RobotControl_B.leftVel1ms_mmPerSec -
      ...
      RobotControl_P.CAL_ROBO_LENG_mm * 0.001 +
    ...
    /* Product: '<S58>/Product' */
    RobotControl_B.deg_m = RobotControl_ConstB.Divide * RobotControl_B.Add1_l;
  ...
  /* End of Logic: '<S19>/Logical_Operator1' */
