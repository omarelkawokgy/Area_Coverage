...
#define RobotCont_IN_NO_ACTIVE_CHILD_mu ((uint8_T)0U)
...
#define RobotControl_IN_TurnLeft_o     ((uint8_T)1U)
#define RobotControl_IN_TurnRight      ((uint8_T)3U)
#define RobotControl_IN_TurnRight_c    ((uint8_T)1U)
...
#define RobotControl_IN_finish_d       ((uint8_T)2U)
...
static void RobotControl_Stop(void)
{
  ...
  if ((RobotControl_DW.moveRequest_prev != RobotControl_DW.moveRequest_start) ||
    ...
    if (RobotControl_B.moveRequest == ((uint8_T)ENU_FORWARD)) {
      ...
      /* Transition: '<S144>:118' */
      RobotControl_DW.is_UturnRight = RobotControl_IN_TurnRight_c;

      /* Entry Internal 'TurnRight': '<S144>:95' */
      /* Transition: '<S144>:96' */
      RobotControl_DW.is_TurnRight_k = RobotControl_IN_start;
      ...
      /* Transition: '<S144>:142' */
      RobotControl_DW.is_Uturn = RobotControl_IN_TurnRight_c;
      ...
      /* Transition: '<S144>:111' */
      RobotControl_DW.is_UturnLeft = RobotControl_IN_TurnLeft_o;

      /* Entry Internal 'TurnLeft': '<S144>:79' */
      /* Transition: '<S144>:80' */
      RobotControl_DW.is_TurnLeft_o = RobotControl_IN_start;
      ...
      /* Transition: '<S144>:218' */
      RobotControl_DW.is_TurnRight_n = RobotControl_IN_start;
...
static void RobotControl_TurnLeft(const boolean_T *Unit_Delay1)
{
  ...
  if ((RobotControl_DW.moveRequest_prev != RobotControl_DW.moveRequest_start) ||
    ...
    if (RobotControl_B.moveRequest == ((uint8_T)ENU_FORWARD)) {
      ...
      RobotControl_DW.is_TurnLeft = RobotCont_IN_NO_ACTIVE_CHILD_mu;
...
static void RobotControl_Uturn(const boolean_T *Unit_Delay1)
{
  ...
  if ((RobotControl_DW.moveRequest_prev != RobotControl_DW.moveRequest_start) ||
    ...
    if (RobotControl_B.moveRequest == ((uint8_T)ENU_FORWARD)) {
      ...
      RobotControl_DW.is_TurnRight = RobotCont_IN_NO_ACTIVE_CHILD_mu;
      RobotControl_DW.is_Uturn = RobotCont_IN_NO_ACTIVE_CHILD_mu;
  ...
  if (guard1) {
    if (RobotControl_DW.is_Uturn == RobotControl_IN_TurnRight_c) {
      /* During 'TurnRight': '<S144>:186' */
      if (RobotControl_DW.uTurnCounter == RobotContro_CONST_UTURN_CNT_THD) {
        /* Transition: '<S144>:246' */
        /* Exit Internal 'TurnRight': '<S144>:186' */
        RobotControl_DW.is_TurnRight = RobotCont_IN_NO_ACTIVE_CHILD_mu;
        RobotControl_DW.is_Uturn = RobotControl_IN_finish_d;
  ...
  boolean_T *Unit_Delay1)
{
  ...
  if (!RobotControl_DW.turnActive) {
    ...
    if (RobotControl_B.moveRequest == ((uint8_T)ENU_FORWARD)) {
      ...
      RobotControl_DW.is_TurnLeft_o = RobotCont_IN_NO_ACTIVE_CHILD_mu;
      RobotControl_DW.is_UturnLeft = RobotCont_IN_NO_ACTIVE_CHILD_mu;
  ...
  if (guard1) {
    switch (RobotControl_DW.is_UturnLeft) {
     case RobotControl_IN_TurnLeft_o:
      ...
      } else if (RobotControl_DW.uTurnCounter == RobotContro_CONST_UTURN_CNT_THD)
      {
        ...
        /* Exit Internal 'TurnLeft': '<S144>:79' */
        RobotControl_DW.is_TurnLeft_o = RobotCont_IN_NO_ACTIVE_CHILD_mu;
        RobotControl_DW.is_UturnLeft = RobotControl_IN_finish_d;

        /* Entry 'finish': '<S144>:112' */
        RobotControl_DW.turnActive = false;
      } else {
        switch (RobotControl_DW.is_TurnLeft_o) {
         case RobotControl_IN_finish:
         ...
         case RobotControl_IN_start:
          ...
          if (RobotControl_B.currentHeading == (uint16_T)
            ...
            /* Transition: '<S144>:82' */
            RobotControl_B.headingRequest = (uint16_T)RobotControl_B.ROB_WEST;
            RobotControl_DW.is_TurnLeft_o = RobotControl_IN_turning;
          } else if (RobotControl_B.currentHeading == (uint16_T)
                     RobotControl_B.ROB_EAST) {
            /* Transition: '<S144>:88' */
            RobotControl_B.headingRequest = (uint16_T)RobotControl_B.ROB_NORTH;
         ...
         default:
          ...
          if ((RobotControl_B.currentHeading == RobotControl_B.headingRequest) &&
              (*Unit_Delay1)) {
            /* Transition: '<S144>:81' */
            RobotControl_DW.is_TurnLeft_o = RobotControl_IN_finish;
     ...
     default:
      ...
      if ((RobotControl_DW.completeStep_prev !=
        ...
        RobotControl_B.turnRequest = ((uint8_T)ENU_CCW);
        RobotControl_DW.turnActive = true;
      } else if (RobotControl_DW.sfEvent_d == RobotControl_event_stopEvent) {
        /* Transition: '<S144>:302' */
        RobotControl_DW.is_UturnLeft = RobotControl_IN_TurnLeft_o;
  ...
  boolean_T *Unit_Delay1)
{
  ...
  if (!RobotControl_DW.turnActive) {
    ...
    if (RobotControl_B.moveRequest == ((uint8_T)ENU_FORWARD)) {
      ...
      RobotControl_DW.is_TurnRight_k = RobotCont_IN_NO_ACTIVE_CHILD_mu;
      RobotControl_DW.is_UturnRight = RobotCont_IN_NO_ACTIVE_CHILD_mu;
  ...
  if (guard1) {
    switch (RobotControl_DW.is_UturnRight) {
     case RobotControl_IN_TurnRight_c:
      ...
      } else if (RobotControl_DW.uTurnCounter == RobotContro_CONST_UTURN_CNT_THD)
      {
        ...
        /* Exit Internal 'TurnRight': '<S144>:95' */
        RobotControl_DW.is_TurnRight_k = RobotCont_IN_NO_ACTIVE_CHILD_mu;
        RobotControl_DW.is_UturnRight = RobotControl_IN_finish_d;

        /* Entry 'finish': '<S144>:120' */
        RobotControl_DW.turnActive = false;
      } else {
        switch (RobotControl_DW.is_TurnRight_k) {
         case RobotControl_IN_finish:
         ...
         case RobotControl_IN_start:
          ...
          if (RobotControl_B.currentHeading == (uint16_T)RobotControl_B.ROB_EAST)
          {
            /* Transition: '<S144>:104' */
            RobotControl_B.headingRequest = (uint16_T)RobotControl_B.ROB_SOUTH;
            RobotControl_DW.is_TurnRight_k = RobotControl_IN_turning;
          } else if (RobotControl_B.currentHeading == (uint16_T)
                     RobotControl_B.ROB_NORTH) {
            /* Transition: '<S144>:98' */
            RobotControl_B.headingRequest = (uint16_T)RobotControl_B.ROB_EAST;
         ...
         default:
          ...
          if ((RobotControl_B.currentHeading == RobotControl_B.headingRequest) &&
              (*Unit_Delay1)) {
            /* Transition: '<S144>:243' */
            RobotControl_DW.is_TurnRight_k = RobotControl_IN_finish;
...
static void RobotControl_forward(void)
{
  ...
  if (RobotControl_DW.moveRequest_prev != RobotControl_DW.moveRequest_start) {
    ...
    if (RobotControl_B.moveRequest == ((uint8_T)ENU_FORWARD)) {
      ...
      /* Transition: '<S144>:11' */
      /* Exit Internal 'forward': '<S144>:4' */
      RobotControl_DW.is_forward = RobotCont_IN_NO_ACTIVE_CHILD_mu;
  ...
  *DataTypeConversion1_n, const boolean_T *Unit_Delay1)
{
  ...
  if (RobotControl_DW.is_active_c37_MOVH == 0U) {
     ...
     case RobotControl_IN_TurnRight:
      ...
      if ((RobotControl_DW.moveRequest_prev != RobotControl_DW.moveRequest_start)
        ...
        if (RobotControl_B.moveRequest == ((uint8_T)ENU_FORWARD)) {
          ...
          RobotControl_DW.is_TurnRight_n = RobotCont_IN_NO_ACTIVE_CHILD_mu;
    ...
    if (guard1) {
      switch (RobotControl_DW.is_TurnRight_n) {
       case RobotControl_IN_finish:
       ...
       case RobotControl_IN_start:
        ...
        if (RobotControl_B.currentHeading == (uint16_T)RobotControl_B.ROB_EAST)
        {
          /* Transition: '<S144>:223' */
          RobotControl_B.headingRequest = (uint16_T)RobotControl_B.ROB_SOUTH;
          RobotControl_DW.is_TurnRight_n = RobotControl_IN_turning;
        } else if (RobotControl_B.currentHeading == (uint16_T)
                   RobotControl_B.ROB_NORTH) {
          /* Transition: '<S144>:219' */
          RobotControl_B.headingRequest = (uint16_T)RobotControl_B.ROB_EAST;
       ...
       default:
        ...
        if ((RobotControl_B.currentHeading == RobotControl_B.headingRequest) &&
            (*Unit_Delay1)) {
          /* Transition: '<S144>:221' */
          RobotControl_DW.is_TurnRight_n = RobotControl_IN_finish;
...
void RobotContr_MovementHandler_Init(void)
{
  ...
  RobotControl_DW.is_c36_MOVH = RobotCont_IN_NO_ACTIVE_CHILD_mu;
  ...
  RobotControl_DW.is_c37_MOVH = RobotCont_IN_NO_ACTIVE_CHILD_mu;
  RobotControl_DW.turnActive = false;
  RobotControl_DW.uTurnCounter = 0U;
  RobotControl_DW.stableCounter = 0U;
...
void RobotControl_MovementHandler(void)
{
  ...
  if (rtb_Relational_Operator_e4 || zcEvent_idx_1) {
    ...
    if ((int8_T)(rtb_Relational_Operator_e4 ? RobotControl_B.refreshEvent ?
      ...
      /* Event: '<S144>:300' */
      RobotControl_DW.sfEvent_d = RobotControl_event_refreshEvent;
    ...
    if ((int8_T)(zcEvent_idx_1 ? RobotControl_B.stopEvent ? RISING_ZCEVENT :
      ...
      /* Event: '<S144>:301' */
      RobotControl_DW.sfEvent_d = RobotControl_event_stopEvent;
  ...
  if (rtb_Divide_e <= RobotCo_CAL_ALLOWED_ERROR_VALUE) {
    /* Transition: '<S145>:4' */
    /* Transition: '<S145>:6' */
    RobotControl_DW.counter_f++;
    if (RobotControl_DW.counter_f > (int16_T)Robo_CONST_TARGET_REACHED_TIMER) {
      /* Transition: '<S145>:15' */
      /* Transition: '<S145>:16' */
      RobotControl_DW.counter_f = 0U;
