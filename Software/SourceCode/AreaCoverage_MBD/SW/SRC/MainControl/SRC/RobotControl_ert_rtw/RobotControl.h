...
typedef struct {
  ...
  uint16_T NVM_NORTH;                  /* '<S7>/EEPROM_IO_Handler_Chart' */
  uint16_T NVM_SOUTH;                  /* '<S7>/EEPROM_IO_Handler_Chart' */
  uint16_T NVM_EAST;                   /* '<S7>/EEPROM_IO_Handler_Chart' */
  uint16_T NVM_WEST;                   /* '<S7>/EEPROM_IO_Handler_Chart' */
  ...
  uint8_T OutportBufferForDIAG_StatusFlg;/* '<S96>/None' */
  uint8_T DIAG_StatusFlg;              /* '<S110>/CONST_DIAG_FINISH_FLG' */
  ...
  uint8_T moveRequest_n;               /* '<S149>/stopRoutine' */
  ...
  B_Analog_uint16_IN_RobotContr_T sf_Analog_uint16_IN1;/* '<S8>/Analog_uint16_IN1' */
  B_Analog_uint16_IN_RobotContr_T sf_Analog_uint16_IN;/* '<S8>/Analog_uint16_IN' */
} B_RobotControl_T;
...
typedef struct {
  ...
  real32_T tempDist_j;                 /* '<S46>/MotorMoveMonitor' */
  real32_T tempDist_f;                 /* '<S101>/GTSP_Chart' */
  ...
  int32_T sfEvent_j;                   /* '<S104>/ZgZgChart' */
  int32_T sfEvent_p;                   /* '<S133>/HighLevelMoves' */
  ...
  uint16_T temporalCounter_i1_i;       /* '<S69>/EOL_TickStateMachine' */
  ...
  uint8_T temporalCounter_i1_k3;       /* '<S112>/CompassSelfDiagTestChart' */
  ...
  uint8_T temporalCounter_i1_c;        /* '<S124>/HighLevelDiagTestControl' */
  ...
  uint8_T is_faceWest_h;               /* '<S104>/ZgZgChart' */
  ...
  uint8_T counter_j;                   /* '<S134>/TargetReachedConfirmTime' */
  ...
  uint8_T is_TurnLeft_f;               /* '<S133>/HighLevelMoves' */
  uint8_T is_Uturn;                    /* '<S133>/HighLevelMoves' */
  uint8_T is_TurnRight;                /* '<S133>/HighLevelMoves' */
  uint8_T is_TurnRight_c;              /* '<S133>/HighLevelMoves' */
  uint8_T is_UturnRight;               /* '<S133>/HighLevelMoves' */
  uint8_T is_TurnRight_b;              /* '<S133>/HighLevelMoves' */
  ...
  uint8_T temporalCounter_i1_a;        /* '<S149>/stopRoutine' */
  ...
  boolean_T initHeading_p;             /* '<S101>/GTSP_Chart' */
 ...
 * '<S12>'  : 'RobotControl/InputHandler/EncoderAnalogIn/Analog_uint16_IN'
 * '<S13>'  : 'RobotControl/InputHandler/EncoderAnalogIn/Analog_uint16_IN1'
