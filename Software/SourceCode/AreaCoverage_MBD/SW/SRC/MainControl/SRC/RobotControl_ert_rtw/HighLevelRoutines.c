...
#define RobotContr_IN_NO_ACTIVE_CHILD_l ((uint8_T)0U)
...
#define RobotContr_event_refreshEvent_g (0L)
#define RobotControl_IN_Freeze         ((uint8_T)1U)
#define RobotControl_IN_Idle_i         ((uint8_T)2U)
...
#define RobotControl_event_stopEvent_a (1L)
...
#define RobotControl_IN_End_b          ((uint8_T)1U)
...
#define RobotControl_IN_Freeze_f       ((uint8_T)2U)
...
#define RobotControl_IN_TurnLeft_c     ((uint8_T)3U)
#define RobotControl_IN_emptyOnRight   ((uint8_T)4U)
#define RobotControl_IN_faceWest_l     ((uint8_T)4U)
...
#define RobotControl_IN_start_m        ((uint8_T)3U)
#define RobotControl_IN_start_mz       ((uint8_T)8U)
...
#define RobotControl_ENU_FINISHED_j    ((uint8_T)4U)
...
#define RobotCont_ENU_MOVE_TURN_RIGHT_l ((uint8_T)21U)
#define RobotContr_ENU_MOVE_TURN_LEFT_f ((uint8_T)20U)
...
#define RobotControl_ENU_STOP_l        ((uint8_T)5U)
#define RobotControl_ENU_TEST_INIT     ((uint8_T)5U)
#define RobotControl_IN_DiagPassed     ((uint8_T)1U)
#define RobotControl_IN_Stop_b         ((uint8_T)1U)
#define RobotControl_IN_init_j         ((uint8_T)2U)
#define RobotControl_IN_turnHandler    ((uint8_T)3U)
#define RobotControl_IN_turnLeft_k     ((uint8_T)2U)
#define RobotControl_IN_turnRightFault ((uint8_T)4U)
#define RobotControl_IN_turnRight_g    ((uint8_T)3U)
  ...
  DW_DeltaDistCalculator_RobotC_T *localDW)
{
  ...
  localDW->is_c30_ROTH = RobotContr_IN_NO_ACTIVE_CHILD_l;
  ...
  DataTypeConversion3_g, real32_T *DataTypeConversion4_m)
{
  ...
  if (RobotControl_DW.is_active_c25_ROTH == 0U) {
    ...
    /* Transition: '<S129>:28' */
    RobotControl_DW.is_c25_ROTH = RobotControl_IN_Idle_i;
    ...
    switch (RobotControl_DW.is_c25_ROTH) {
     case RobotControl_IN_Freeze:
      ...
      if (RobotControl_DW.sfEvent_e == RobotControl_event_stopEvent_a) {
        /* Transition: '<S129>:32' */
        if (RobotControl_B.sensorView == ((uint8_T)ENU_LEFT_EMPTY_RIGHT_EMPTY))
        {
          ...
          if (RobotControl_B.currentHeading == *DataTypeConversion3_g) {
            ...
            /* Transition: '<S129>:41' */
            RobotControl_B.moveRequest_c = ((uint8_T)ENU_MOVE_U_TURN_RIGHT);
            ...
            /* Transition: '<S129>:43' */
            RobotControl_B.moveRequest_c = ((uint8_T)ENU_MOVE_U_TURN_LEFT);
     ...
     case RobotControl_IN_SwitchLane:
      ...
      if (RobotControl_DW.finishCounter > ((uint8_T)CAL_ZgZgCounterThd)) {
        ...
        RobotControl_B.moveRequest_c = ((uint8_T)ENU_STOP);
      } else {
        if ((RobotControl_DW.headingRequest == RobotControl_B.currentHeading) &&
          ...
          RobotControl_B.moveRequest_c = ((uint8_T)ENU_FORWARD);
        }
      }
      break;
        ...
        switch (RobotControl_DW.is_faceWest_f) {
         case RobotControl_IN_Start:
          ...
          if (RobotControl_B.currentHeading == *DataTypeConversion4_m) {
            ...
            RobotControl_B.moveRequest_c = ((uint8_T)ENU_MOVE_U_TURN);
            ...
            RobotControl_B.moveRequest_c = ((uint8_T)ENU_MOVE_TURN_RIGHT);
            ...
            RobotControl_B.moveRequest_c = ((uint8_T)ENU_MOVE_TURN_LEFT);
          } else {
            if (RobotControl_B.currentHeading == *DataTypeConversion3_g) {
              /* Transition: '<S129>:101' */
  ...
  DataTypeConversion2, real32_T *DataTypeConversion3_l)
{
  ...
  if (RobotControl_DW.is_active_c24_ROTH == 0U) {
    ...
    /* Transition: '<S128>:6' */
    RobotControl_DW.is_c24_ROTH = RobotControl_IN_Idle_i;

    /* Entry 'Idle': '<S128>:5' */
    RobotControl_DW.counter = 0U;

    /* Constant: '<S101>/ENU_STOP' */
    RobotControl_B.moveRequest_a = ((uint8_T)ENU_STOP);
    ...
    switch (RobotControl_DW.is_c24_ROTH) {
     case RobotControl_IN_GTSP_Active:
      ...
      if (RobotControl_B.currentRoutine != ((uint8_T)ENU_GTSP)) {
        ...
        RobotControl_DW.is_MostSouthLeft = RobotControl_IN_start_m;
      } else {
        switch (RobotControl_DW.is_GTSP_Active) {
         case RobotControl_IN_Forward:
          ...
          if (RobotControl_B.hitRoutineRun) {
            /* Transition: '<S128>:13' */
            RobotControl_DW.is_GTSP_Active = RobotControl_IN_Freeze_f;
          }
          break;

         case RobotControl_IN_Freeze_f:
          /* During 'Freeze': '<S128>:193' */
          if (RobotControl_DW.sfEvent == RobotControl_event_stopEvent_a) {
            /* Transition: '<S128>:194' */
            if ((RobotControl_B.sensorView == ((uint8_T)
              ...
              if (RobotControl_B.currentHeading == *DataTypeConversion) {
                /* Transition: '<S128>:18' */
                RobotControl_DW.is_GTSP_Active = RobotControl_IN_TurnLeft_c;

                /* Constant: '<S101>/ENU_MOVE_TURN_LEFT' */
                /* Entry 'TurnLeft': '<S128>:12' */
                RobotControl_B.moveRequest_a = ((uint8_T)ENU_MOVE_TURN_LEFT);
         ...
         case RobotControl_IN_TurnLeft_c:
          ...
          if ((RobotControl_B.currentHeading == *DataTypeConversion2) &&
            ...
            RobotControl_B.moveRequest_a = ((uint8_T)ENU_FORWARD);
          }
          break;
     ...
     case RobotControl_IN_Idle_i:
      ...
      if ((RobotControl_B.currentRoutine == ((uint8_T)ENU_GTSP)) &&
        ...
        /* Transition: '<S128>:8' */
        RobotControl_DW.is_c24_ROTH = RobotControl_IN_faceWest_l;
        ...
        RobotControl_DW.initHeading_d = false;
      } else {
        ...
        if (!RobotControl_DW.activeFlag) {
          ...
          switch (RobotControl_DW.is_facingSouth) {
           ...
           case RobotControl_IN_Freeze_f:
            ...
            if (RobotControl_DW.sfEvent == RobotControl_event_stopEvent_a) {
              /* Transition: '<S128>:155' */
              RobotControl_DW.is_facingSouth = RobotControl_IN_End_b;
           ...
           default:
            ...
            if ((*DataTypeConversion1_g == RobotControl_B.currentHeading) &&
              ...
              /* Constant: '<S101>/ENU_STOP' */
              RobotControl_B.moveRequest_a = ((uint8_T)ENU_STOP);
              RobotControl_DW.is_facingSouth = RobotControl_IN_Freeze_f;
            } else {
              switch (RobotControl_DW.is_GTSPsearch) {
               case RobotControl_IN_Freeze3:
                ...
                if (RobotControl_DW.sfEvent == RobotControl_event_stopEvent_a) {
                  ...
                  RobotControl_B.moveRequest_a = ((uint8_T)ENU_MOVE_TURN_RIGHT);
                }
                break;
               ...
               case RobotControl_IN_furtherDown:
                ...
                if ((RobotControl_B.currentHeading == *DataTypeConversion1_g) &&
                    RobotControl_B.OutportBufferFortargetReached) {
                  /* Transition: '<S128>:93' */
                  RobotControl_DW.is_GTSPsearch = RobotControl_IN_start_mz;
               ...
               case RobotControl_IN_intermediate:
                ...
                if (RobotControl_B.hitRoutineRun) {
                  ...
                  if (*forwardDist - RobotControl_DW.tempDist_d >
               ...
               default:
                ...
                if (((RobotControl_B.sensorView == ((uint8_T)
                  ...
                  if ((RobotControl_B.sensorView == ((uint8_T)
                    ...
                    RobotControl_DW.tempDist_d = *forwardDist;
                  }
                }
                break;
              }
     ...
     default:
      ...
      if (RobotControl_DW.initHeading_d) {
        /* Transition: '<S128>:139' */
        ...
        switch (RobotControl_DW.is_faceWest) {
         case RobotControl_IN_Start:
          ...
          if (RobotControl_B.currentHeading == *DataTypeConversion1_g) {
            ...
            RobotControl_B.moveRequest_a = ((uint8_T)ENU_MOVE_U_TURN);
          } else if (RobotControl_B.currentHeading == *DataTypeConversion2) {
            /* Transition: '<S128>:133' */
            ...
            if (RobotControl_B.currentHeading == *DataTypeConversion) {
              ...
              RobotControl_DW.initHeading_d = true;
            }
          }
          break;
...
void RobotCon_HighLevelRoutines_Init(void)
{
  ...
  RobotControl_DW.initHeading = 0.0;
  RobotControl_B.moveRequest_c = 0U;
  RobotControl_B.zgzgActive = true;
  RobotControl_B.switchLaneFlg_BOOL = false;
  ...
  RobotControl_DW.initHeading_d = false;
  RobotControl_DW.activeFlag = false;
  RobotControl_DW.tempDist_d = 0.0F;
  RobotControl_B.moveRequest_a = 0U;
  RobotControl_B.GT_active = true;
  ...
  RobotControl_DW.temporalCounter_i1_o = 0U;
...
void RobotControl_HighLevelRoutines(void)
{
  ...
  if ((rtPrevAction != rtAction) && (rtPrevAction == 2)) {
    ...
    if ((RobotControl_DW.Switch_Case_ActiveSubsystem_j == 3) &&
        RobotControl_DW.Angle_CalibrationUponReq_MODE) {
  ...
  switch (rtAction) {
   case 0:
    ...
    if (zcEvent_idx_0 || zcEvent_idx_1) {
      ...
      if ((int8_T)(zcEvent_idx_0 ? RobotControl_B.refreshEvent ? RISING_ZCEVENT :
        ...
        /* Event: '<S129>:89' */
        RobotControl_DW.sfEvent_e = RobotContr_event_refreshEvent_g;
      ...
      if ((int8_T)(zcEvent_idx_1 ? RobotControl_B.stopEvent ? RISING_ZCEVENT :
                   FALLING_ZCEVENT : NO_ZCEVENT) != 0) {
        /* Event: '<S129>:88' */
        RobotControl_DW.sfEvent_e = RobotControl_event_stopEvent_a;
        RobotControl_chartstep_c25_ROTH(&forwardDist, &DataTypeConversion2_m,
          &DataTypeConversion3_g, &DataTypeConversion4_m);
      }
    }
    ...
    RobotControl_B.Merge = RobotControl_B.moveRequest_c;
   ...
   case 1:
    ...
    if (zcEvent_idx_0 || zcEvent_idx_1) {
      ...
      if ((int8_T)(zcEvent_idx_0 ? RobotControl_B.refreshEvent ? RISING_ZCEVENT :
                   FALLING_ZCEVENT : NO_ZCEVENT) != 0) {
        /* Event: '<S128>:146' */
        RobotControl_DW.sfEvent = RobotContr_event_refreshEvent_g;
      ...
      if ((int8_T)(zcEvent_idx_1 ? RobotControl_B.stopEvent ? RISING_ZCEVENT :
                   FALLING_ZCEVENT : NO_ZCEVENT) != 0) {
        /* Event: '<S128>:145' */
        RobotControl_DW.sfEvent = RobotControl_event_stopEvent_a;
        RobotControl_chartstep_c24_ROTH(&forwardDist, &DataTypeConversion2_m,
          &DataTypeConversion3_g, &DataTypeConversion4_m, &DataTypeConversion3_l);
      }
    }
    ...
    RobotControl_B.Merge = RobotControl_B.moveRequest_a;
   ...
   case 2:
    ...
    if (RobotControl_DW.temporalCounter_i1_o < 15U) {
      RobotControl_DW.temporalCounter_i1_o++;
    }
    ...
    if (RobotControl_DW.is_active_c26_ROTH == 0U) {
      ...
      if (RobotControl_DW.Unit_Delay2_DSTATE_h == RobotControl_ENU_FINISHED_j) {
        /* Transition: '<S125>:55' */
        RobotControl_B.enableAngleCalib_BOOL = false;
        RobotControl_DW.is_c26_ROTH = RobotControl_IN_SelfDiag;
      ...
      switch (RobotControl_DW.is_SelfDiag) {
       ...
       case RobotControl_IN_CompassRoutine:
        ...
        if (RobotControl_DW.Unit_Delay_DSTATE_j == RobotControl_ENU_PASSED) {
          ...
          if (RobotControl_DW.temporalCounter_i1_o >=
    ...
    /* Disable for Enabled SubSystem: '<S105>/Angle_CalibrationUponReq' */
    if ((rtPrevAction != rtAction) && (rtPrevAction == 3) &&
        RobotControl_DW.Angle_CalibrationUponReq_MODE) {
      RobotControl_DW.Angle_CalibrationUponReq_MODE = false;
    }
    ...
    switch (rtAction) {
     case 0:
      ...
      if (RobotControl_DW.is_active_c31_ROTH == 0U) {
        ...
        /* Transition: '<S116>:2' */
        RobotControl_DW.is_c31_ROTH = RobotControl_IN_init_j;

        /* Entry 'init': '<S116>:1' */
        RobotControl_B.comTstStatus = RobotControl_ENU_TEST_INIT;
        RobotControl_B.moveReq_k = RobotControl_ENU_STOP_l;
        RobotControl_DW.steps = 0U;
        RobotControl_DW.filterToleranceCnt = 0U;
      } else {
        switch (RobotControl_DW.is_c31_ROTH) {
         ...
         case RobotControl_IN_init_j:
          ...
          if ((RobotControl_B.currentHeading != RobotControl_ENU_ROB_NONE) &&
            ...
            RobotControl_DW.is_turnHandler = RobotControl_IN_Stop_b;
         ...
         case RobotControl_IN_turnHandler:
          ...
          if ((RobotControl_DW.steps > 0) &&
            ...
            switch (RobotControl_DW.is_turnHandler) {
             case RobotControl_IN_Stop_b:
              /* During 'Stop': '<S116>:5' */
              if (RobotControl_DW.steps == 0) {
                /* Transition: '<S116>:38' */
                RobotControl_DW.steps++;
                RobotControl_B.moveReq_k = RobotCont_ENU_MOVE_TURN_RIGHT_l;
                RobotControl_DW.is_turnHandler = RobotControl_IN_turnRight_g;
                          ...
                          &DataTypeConversion3_g, &DataTypeConversion4_m) != 0.0)
              {
                ...
                /* Transition: '<S116>:39' */
                RobotControl_DW.steps++;
                RobotControl_B.moveReq_k = RobotContr_ENU_MOVE_TURN_LEFT_f;
                RobotControl_DW.is_turnHandler = RobotControl_IN_turnLeft_k;
              } else {
             ...
             case RobotControl_IN_turnLeft_k:
      ...
      RobotControl_B.Merge = RobotControl_B.moveReq_k;
     ...
     case 3:
      ...
      if (!RobotControl_B.NVM_AngleStoreFlg) {
        ...
        if (RobotControl_DW.temporalCounter_i1_j < 15U) {
        ...
        if (RobotControl_DW.is_active_c27_ROTH == 0U) {
          ...
          RobotControl_B.moveReq = RobotControl_ENU_STOP_l;
          ...
          switch (RobotControl_DW.is_c27_ROTH) {
           case RobotControl_IN_FacingEAST:
            ...
            if (RobotControl_DW.temporalCounter_i1_j >=
                Ro_CONST_COMPASS_DIAG_FIN_TIMER) {
              /* Transition: '<S113>:40' */
              ...
              RobotControl_B.moveReq = RobotCont_ENU_MOVE_TURN_RIGHT_l;
            }
            break;
           ...
           case RobotControl_IN_Moving:
            ...
            if ((RobotControl_B.currentHeading == RobotControl_CAL_EAST) &&
              ...
              if ((RobotControl_B.currentHeading == RobotControl_CAL_NORTH) &&
                ...
                RobotControl_B.moveReq = RobotControl_ENU_STOP_l;
                RobotControl_B.angleCalibStatus = RobotControl_ENU_FINISHED_j;
              }
            }
            break;
  ...
  /* Switch: '<S27>/Switch' */
  if (RobotControl_B.hitRoutineRun) {
    RobotControl_B.moveRequest = RobotControl_B.moveRequest_p;
  } else {
