...
void RobotControl_EncoderAnalogIn(void)
{
  ...
  /* Transition: '<S13>:2' */
  /* Transition: '<S13>:4' */
  RobotControl_B.value = (uint16_T)analogRead(((uint8_T)PIN_A0));
  ...
  /* Transition: '<S12>:2' */
  /* Transition: '<S12>:4' */
  RobotControl_B.value_i = (uint16_T)analogRead(((uint8_T)PIN_A1));
}
...
void RobotControl_DSCA(void)
{
   ...
   */
  rtb_Switch_l = (RobotControl_B.value_i > CAL_EncoderAnaThd);
   ...
   */
  rtb_Switch1_k = (RobotControl_B.value > CAL_EncoderAnaThd);
