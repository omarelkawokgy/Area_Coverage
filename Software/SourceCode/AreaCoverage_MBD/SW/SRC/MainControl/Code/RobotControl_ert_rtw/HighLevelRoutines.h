...
/* Block signals for system '<S120>/DeltaDistCalculator' */
typedef struct {
  real32_T deltaDistTrav;              /* '<S120>/DeltaDistCalculator' */
} B_DeltaDistCalculator_RobotCo_T;

/* Block states (auto storage) for system '<S120>/DeltaDistCalculator' */
typedef struct {
  real32_T tempDist;                   /* '<S120>/DeltaDistCalculator' */
  uint8_T is_active_c30_ROTH;          /* '<S120>/DeltaDistCalculator' */
  uint8_T is_c30_ROTH;                 /* '<S120>/DeltaDistCalculator' */
