...
static void c7_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint16_T c7_h_emlrt_marshallIn(SFc7_AreaCoverageTestHarnessInstanceStruct
  *chartInstance, const mxArray *c7_b_NVM_SOUTH, const char_T *c7_identifier);
static uint16_T c7_i_emlrt_marshallIn(SFc7_AreaCoverageTestHarnessInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
  ...
  (SFc7_AreaCoverageTestHarnessInstanceStruct *chartInstance)
{
  ...
  if (!(sf_get_output_port_reusable(chartInstance->S, 1) != 0)) {
    *chartInstance->c7_NVM_AngleStoreFlg = false;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c7_NVM_AngleStoreFlg, 5U, 1U,
  ...
  if (!(sf_get_output_port_reusable(chartInstance->S, 3) != 0)) {
    *chartInstance->c7_NVM_SOUTH = 0U;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c7_NVM_SOUTH, 7U, 1U, 6U,
                          chartInstance->c7_sfEvent, false);
  }

  if (!(sf_get_output_port_reusable(chartInstance->S, 4) != 0)) {
    *chartInstance->c7_NVM_EAST = 0U;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c7_NVM_EAST, 8U, 1U, 6U,
                          chartInstance->c7_sfEvent, false);
  }

  if (!(sf_get_output_port_reusable(chartInstance->S, 5) != 0)) {
    *chartInstance->c7_NVM_WEST = 0U;
    _SFD_DATA_RANGE_CHECK((real_T)*chartInstance->c7_NVM_WEST, 9U, 1U, 6U,
                          chartInstance->c7_sfEvent, false);
  }
}
  ...
  (SFc7_AreaCoverageTestHarnessInstanceStruct *chartInstance)
{
  ...
  uint16_T c7_d_hoistedGlobal;
  const mxArray *c7_e_y = NULL;
  uint16_T c7_e_hoistedGlobal;
  ...
  c7_c_y = NULL;
  sf_mex_assign(&c7_c_y, sf_mex_create("y", &c7_b_hoistedGlobal, 5, 0U, 0U, 0U,
    0), false);
  ...
  c7_e_y = NULL;
  sf_mex_assign(&c7_e_y, sf_mex_create("y", &c7_d_hoistedGlobal, 5, 0U, 0U, 0U,
    0), false);
  sf_mex_setcell(c7_y, 3, c7_e_y);
  c7_e_hoistedGlobal = *chartInstance->c7_NVM_WEST;
  c7_f_y = NULL;
  sf_mex_assign(&c7_f_y, sf_mex_create("y", &c7_e_hoistedGlobal, 5, 0U, 0U, 0U,
    0), false);
   ...
   *c7_st)
{
  ...
  *chartInstance->c7_NVM_AngleStoreFlg = c7_d_emlrt_marshallIn(chartInstance,
    ...
    "NVM_AngleStoreFlg");
  *chartInstance->c7_NVM_EAST = c7_h_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  *chartInstance->c7_NVM_SOUTH = c7_h_emlrt_marshallIn(chartInstance, sf_mex_dup
    (sf_mex_getcell("NVM_SOUTH", c7_u, 3)), "NVM_SOUTH");
  *chartInstance->c7_NVM_WEST = c7_h_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  *chartInstance, const mxArray *c7_b_NVM_SOUTH, const char_T *c7_identifier)
{
  ...
  c7_thisId.fParent = NULL;
  c7_thisId.bParentIsCell = false;
  c7_y = c7_i_emlrt_marshallIn(chartInstance, sf_mex_dup(c7_b_NVM_SOUTH),
    &c7_thisId);
  sf_mex_destroy(&c7_b_NVM_SOUTH);
  return c7_y;
}
  ...
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData)
{
  ...
  chartInstance = (SFc7_AreaCoverageTestHarnessInstanceStruct *)
    chartInstanceVoid;
  c7_b_NVM_SOUTH = sf_mex_dup(c7_mxArrayInData);
  c7_identifier = c7_varName;
  c7_thisId.fIdentifier = c7_identifier;
  c7_thisId.fParent = NULL;
  c7_thisId.bParentIsCell = false;
  ...
  chartInstance)
{
  ...
  chartInstance->c7_NVM_NORTH = (int16_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
  chartInstance->c7_NVM_SOUTH = (uint16_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 3);
  chartInstance->c7_NVM_EAST = (uint16_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 4);
  chartInstance->c7_NVM_WEST = (uint16_T *)ssGetOutputPortSignal_wrapper
    (chartInstance->S, 5);
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3958895691U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4131064797U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1443415390U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3385602147U);
}
...
mxArray *sf_c7_AreaCoverageTestHarness_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("QLnMr31Xk7Qfgmxbqpj2");
...
mxArray *sf_c7_AreaCoverageTestHarness_jit_fallback_info(void)
{
  ...
  mxArray *incompatibleSymbol = mxCreateString("EEPROM_Read_Wrapper");
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_SET_DATA_COMPILED_PROPS(7,SF_UINT16,0,NULL,0,0,0,0.0,1.0,0,0,
          (MexFcnForType)c7_c_sf_marshallOut,(MexInFcnForType)c7_e_sf_marshallIn);
...
{
  return "sPsV1j1kcIOkHL56KclY5uB";
}
...
static void mdlSetWorkWidths_c7_AreaCoverageTestHarness(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1674282566U));
  ssSetChecksum1(S,(112926185U));
  ssSetChecksum2(S,(38725436U));
  ssSetChecksum3(S,(2250903729U));
