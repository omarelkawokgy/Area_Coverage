...
void RobotCon_HighLevelRoutines_Init(void)
{
  ...
  RobotControl_DW.Unit_Delay_DSTATE_h =
    RobotControl_P.Unit_Delay_InitialCondition_n;

  /* InitializeConditions for UnitDelay: '<S21>/Unit_Delay1' */
  RobotControl_DW.Unit_Delay1_DSTATE_c =
    RobotControl_P.Unit_Delay1_InitialCondition_a;
  ...
  RobotControl_B.moveRequest = RobotControl_P.Unit_Delay2_InitialCondition_e;
  ...
  RobotControl_B.OutportBufferForGT_active = RobotControl_P.GT_active_Y0;
  ...
  RobotControl_B.encoderDistErrorFlg_BOOL_m =
    RobotControl_P.rightEncodDistErrorFlg_BOOL_Y0;

  /* SystemInitialize for Outport: '<S102>/leftEncodDistErrorFlg_BOOL' */
  RobotControl_B.encoderDistErrorFlg_BOOL =
    RobotControl_P.leftEncodDistErrorFlg_BOOL_Y0;

  /* SystemInitialize for Outport: '<S102>/encoderTstStatus' */
  RobotControl_B.encoderTstStatus = RobotControl_P.encoderTstStatus_Y0;
  ...
  RobotControl_B.hardwareFaultFlg = RobotControl_P.hardwareFaultFlg_Y0;
