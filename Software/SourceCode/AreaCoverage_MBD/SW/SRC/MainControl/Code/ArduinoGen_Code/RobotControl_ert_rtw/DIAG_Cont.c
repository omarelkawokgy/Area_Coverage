...
void RobotControl_DIAG_Cont_Init(void)
{
  ...
  RobotControl_B.failFlag = RobotControl_P.failFlag_Y0;

  /* SystemInitialize for Outport: '<S18>/ULSL_NotConnectedFlag_BOOL' */
  RobotControl_B.ULS_NotConnectedFlag_BOOL =
    RobotControl_P.ULSL_NotConnectedFlag_BOOL_Y0;

  /* SystemInitialize for Outport: '<S18>/ULSR_NotConnectedFlag_BOOL' */
  RobotControl_B.ULS_NotConnectedFlag_BOOL_j =
    RobotControl_P.ULSR_NotConnectedFlag_BOOL_Y0;

  /* SystemInitialize for Outport: '<S18>/redLED_BOOL' */
  RobotControl_B.redLED_BOOL = RobotControl_P.redLED_BOOL_Y0;

  /* SystemInitialize for Outport: '<S18>/greenLED_BOOL' */
  RobotControl_B.greenLED_BOOL = RobotControl_P.greenLED_BOOL_Y0;
}
