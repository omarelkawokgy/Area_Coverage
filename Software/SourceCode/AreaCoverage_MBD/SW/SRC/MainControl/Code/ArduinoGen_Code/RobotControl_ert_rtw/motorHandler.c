...
void RobotControl_motorHandler_Init(void)
{
  ...
  RobotControl_DW.FixPtUnitDelay2_DSTATE =
    RobotControl_P.FixPtUnitDelay2_InitialCondit_m;

  /* InitializeConditions for UnitDelay: '<S147>/FixPt Unit Delay1' */
  RobotControl_DW.FixPtUnitDelay1_DSTATE =
    RobotControl_P.Unit_Delay_Resettable_vinit;

  /* SystemInitialize for Outport: '<S25>/leftPosPin' */
  RobotControl_B.leftPosPin = RobotControl_P.leftPosPin_Y0;

  /* SystemInitialize for Outport: '<S25>/leftNegPin' */
  RobotControl_B.leftNegPin = RobotControl_P.leftNegPin_Y0;

  /* SystemInitialize for Outport: '<S25>/rightPosPin' */
  RobotControl_B.rightPosPin = RobotControl_P.rightPosPin_Y0;

  /* SystemInitialize for Outport: '<S25>/rightNegPin' */
  RobotControl_B.rightNegPin = RobotControl_P.rightNegPin_Y0;
}
...
void RobotControl_motorHandler(void)
{
  ...
  {
    rtb_Add_b = RobotControl_P.Unit_Delay_Resettable_vinit;
  } else {
  ...
  if (RobotControl_P.CONST_EndOfLineEnableFlg) {
    ...
    if (rtb_LogicalOperator_l) {
      ...
      } else if (rtb_Add_b < RobotControl_P.Saturation_LowerSat_b) {
        rtb_Abs_i = RobotControl_P.Saturation_LowerSat_b;
      } else {
        rtb_Abs_i = rtb_Add_b;
      }
   ...
   */
  RobotControl_DW.FixPtUnitDelay2_DSTATE = RobotControl_P.FixPtConstant_Value_m;
