...
## Generated on : Wed Jul 29 10:39:37 2020
## MATLAB Coder version: 3.2 (R2016b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/RobotControl.elf
...
PRODUCT_NAME              = RobotControl
MAKEFILE                  = RobotControl.mk
COMPUTER                  = PCWIN64
MATLAB_ROOT               = C:/TOOLS/MATLAB
MATLAB_BIN                = C:/TOOLS/MATLAB/bin
MATLAB_ARCH_BIN           = C:/TOOLS/MATLAB/bin/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Projects/myProject/CleanerRepo/Area_Coverage/Software/SourceCode/AreaCoverage_MBD/SW/SRC/MainControl/SRC
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = RobotControl_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/RobotControl.elf
...
%.o : $(START_DIR)/RobotControl_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/RobotControl_ert_rtw/%.s
	$(AS) $(ASFLAGS)  "$@" "$<"


%.o : $(START_DIR)/RobotControl_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
