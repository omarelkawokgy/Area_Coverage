...
struct P_EncoderIncrement_RobotContr_T_ {
  int32_T distCounter_Y0;              /* Computed Parameter: distCounter_Y0
                                        * Referenced by: '<S56>/distCounter'
                                        */
  int32_T Unit_Delay_InitialCondition; /* Computed Parameter: Unit_Delay_InitialCondition
                                        * Referenced by: '<S56>/Unit_Delay'
                                        */
};

extern void RobotCont_EncoderIncrement_Init(B_EncoderIncrement_RobotContr_T
  *localB, P_EncoderIncrement_RobotContr_T *localP);
