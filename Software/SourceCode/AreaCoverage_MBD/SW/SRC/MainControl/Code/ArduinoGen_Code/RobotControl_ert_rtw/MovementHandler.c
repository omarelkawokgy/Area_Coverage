...
void RobotContr_MovementHandler_Init(void)
{
  ...
  RobotControl_DW.Unit_Delay5_DSTATE_n =
    RobotControl_P.Unit_Delay5_InitialCondition_c;

  /* InitializeConditions for UnitDelay: '<S22>/Unit_Delay1' */
  RobotControl_DW.Unit_Delay1_DSTATE_p =
    RobotControl_P.Unit_Delay1_InitialCondition;

  /* InitializeConditions for UnitDelay: '<S125>/Unit Delay' */
  RobotControl_DW.UnitDelay_DSTATE = RobotControl_P.UnitDelay_InitialCondition;

  /* InitializeConditions for UnitDelay: '<S22>/Unit_Delay2' */
  RobotControl_DW.Unit_Delay2_DSTATE_o =
    RobotControl_P.Unit_Delay2_InitialCondition_j;

  /* InitializeConditions for UnitDelay: '<S136>/FixPt Unit Delay2' */
  RobotControl_DW.FixPtUnitDelay2_DSTATE_j =
    RobotControl_P.FixPtUnitDelay2_InitialCondit_j;

  /* InitializeConditions for UnitDelay: '<S136>/FixPt Unit Delay1' */
  RobotControl_DW.FixPtUnitDelay1_DSTATE_p =
    RobotControl_P.Unit_Delay_Enabled_Resettable_v;

  /* InitializeConditions for UnitDelay: '<S137>/FixPt Unit Delay2' */
  RobotControl_DW.FixPtUnitDelay2_DSTATE_jh =
    RobotControl_P.FixPtUnitDelay2_InitialCondit_k;

  /* InitializeConditions for UnitDelay: '<S137>/FixPt Unit Delay1' */
  RobotControl_DW.FixPtUnitDelay1_DSTATE_l =
    RobotControl_P.Unit_Delay_Enabled_Resettabl_hd;

  /* InitializeConditions for UnitDelay: '<S22>/Unit_Delay3' */
  RobotControl_DW.Unit_Delay3_DSTATE_c =
    RobotControl_P.Unit_Delay3_InitialCondition_p;
  ...
  RobotControl_B.rightMotorRequest = RobotControl_P.rightMotorRequest_Y0;

  /* SystemInitialize for Outport: '<S22>/leftMotorRequest' */
  RobotControl_B.leftMotorRequest = RobotControl_P.leftMotorRequest_Y0;

  /* SystemInitialize for Outport: '<S22>/thetaError' */
  RobotControl_B.thetaError = RobotControl_P.thetaError_Y0;

  /* SystemInitialize for Outport: '<S22>/targetReached' */
  RobotControl_B.OutportBufferFortargetReached = RobotControl_P.targetReached_Y0;

  /* SystemInitialize for Outport: '<S22>/turnRequest1' */
  RobotControl_B.turnRequestFiltered = RobotControl_P.turnRequest1_Y0;
}
...
void RobotControl_MovementHandler(void)
{
  ...
  if (RobotControl_DW.Unit_Delay2_DSTATE_o ||
    ...
    rtb_Divide_e = RobotControl_P.Unit_Delay_Enabled_Resettable_v;
  } else {
  ...
  if (RobotControl_DW.Unit_Delay2_DSTATE_o ||
    ...
    rtb_Init_g = RobotControl_P.Unit_Delay_Enabled_Resettabl_hd;
  } else {
   ...
   */
  if (rtb_Add_c > RobotControl_P.Constant_Value_b) {
    /* MinMax: '<S133>/MinMax' incorporates:
     *  Constant: '<S125>/Constant'
     */
    if (RobotControl_P.Constant_Value_j <= rtb_Add_c) {
      rtb_DataTypeConversion_b = RobotControl_P.Constant_Value_j;
    } else {
     ...
     *  Constant: '<S125>/Constant'
     */
    u1 = RobotControl_P.Gain_Gain * RobotControl_P.Constant_Value_j;

    /* MinMax: '<S133>/MinMax1' */
    if ((rtb_Add_c >= u1) || rtIsNaNF(u1)) {
      rtb_DataTypeConversion_b = rtb_Add_c;
    } else {
      rtb_DataTypeConversion_b = u1;
    }
