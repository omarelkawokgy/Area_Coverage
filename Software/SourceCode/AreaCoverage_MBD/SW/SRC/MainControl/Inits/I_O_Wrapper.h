...
void EEPROM_Read_Wrapper(bool* NVM_AngleStoreFlg, uint16_t* NVM_NORTH, uint16_t* NVM_SOUTH, uint16_t* NVM_EAST, uint16_t* NVM_WEST);
...
void EEPROM_Read_Wrapper(bool* NVM_AngleStoreFlg, uint16_t* NVM_NORTH_, uint16_t* NVM_SOUTH, uint16_t* NVM_EAST, uint16_t* NVM_WEST);
